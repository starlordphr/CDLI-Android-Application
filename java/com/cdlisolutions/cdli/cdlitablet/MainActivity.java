...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkConnection(){
        ...
        FrameLayout coordinatorLayout=(FrameLayout)findViewById(R.id.main_content);

        if(ConnectivityChecker.isConnected(getApplicationContext())) {
            JSON_HTTP_CALL(null, "initial_fetch");
        }
        else{
            Snackbar.make(coordinatorLayout,"No Network",Snackbar.LENGTH_INDEFINITE)
    ...
    public String getEmailBody(int counter)
    {
        ...
        temp+="Visit this page on the web: "+WEB_VERSION+getDate(counter)+"\n";
        temp+="Download the free \"cdli tablet\" app: Link yet to come";
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        boolean isImageFullscreen=false;
        ...
        public void onPause(){
            super.onPause();
            appbar.setAlpha(1);
            descLayout.setAlpha(1);
        }
        @Override
        public void onResume(){
            super.onResume();
            if(appbar.getAlpha()==0){
                fadeInEffect(appbar,descLayout);
            }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            imageView=(TouchImageView)rootView.findViewById(R.id.image_view);

            final FrameLayout dummy_view=rootView.findViewById(R.id.dummy_view);

            descLayout=(LinearLayout) rootView.findViewById(R.id.desc_layout);
                ...
                public void onClick(View view) {
                  //  Toast.makeText(getContext(),"Single Tap",Toast.LENGTH_SHORT).show();
                    ...
                    if(isImageFullscreen){
                        ...
                        fadeOutEffect(appbar,descLayout);
                        isImageFullscreen=true;
                    }
            ...
            more_less.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(isDescExpanded){
                        CollapseView(descLayout,dummy_view);
                       ...
                       // imageView.setEnabled(true);
                        ...
                        ExpandView(descLayout,dummy_view);
                        //Set desc as shortText
        ...
        private void fadeInEffect(final View...views) {
            ValueAnimator alpha_anim=ValueAnimator.ofFloat(0F,1.0F);
            alpha_anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    float val=(Float) valueAnimator.getAnimatedValue();
                    for (View v:views)
            ...
            alpha_anim.addListener(new Animator.AnimatorListener() {
                @Override
            ...
            alpha_anim.setDuration(1*1000);
            alpha_anim.start();
        }
        private void fadeOutEffect(final View...views) {
            ValueAnimator alpha_anim=ValueAnimator.ofFloat(1.0F,0F);
            alpha_anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @Override
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    float val=(Float) valueAnimator.getAnimatedValue();
        ...
        private void ExpandView(final View v, final View rootView) {
            ...
            //get AppBar Size to set Top Margin
    ...
    class DownloadFile extends AsyncTask<String,Integer,Long> {
        ...
        protected void onPostExecute(Long aLong) {
            ...
            //intent.putExtra(Intent.EXTRA_HTML_TEXT,setHtmlText(getEmailBody(mViewPager.getCurrentItem())));
